...
def chatbot():
    nombre_negocio = "LegalExpress"

    servicios = {
        "1": {
            "nombre": "Consulta legal básica",
            "preguntas": [
                "¿Tienes una cita judicial en los próximos 15 días? (si/no): ",
                "¿El caso es civil, penal o laboral? (civil/penal/laboral): "
            ],
            "respuestas_validas": [
                ["si", "no"],
                ["civil", "penal", "laboral"]
        ...
        "2": {
            ...
            "preguntas": [
                "¿Qué tipo de contrato necesitas? (alquiler, laboral, otro): ",
                "¿Necesitas revisión legal adicional? (si/no): "
            ],
            "respuestas_validas": [
                ["alquiler", "laboral", "otro"],
                ["si", "no"]
            ]
        },
        "3": {
            ...
            "preguntas": [
                "¿Tu empresa está registrada legalmente? (si/no): ",
                "¿Quieres asesoría en impuestos o normativas? (impuestos/normativas): "
            ],
            "respuestas_validas": [
                ["si", "no"],
